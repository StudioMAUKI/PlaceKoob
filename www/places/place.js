...
.controller('placeCtrl', ['$scope', '$ionicHistory', '$stateParams', 'RemoteAPIService', 'PostHelper', function($scope, $ionicHistory, $stateParams, RemoteAPIService, PostHelper) {
  var place = this
  place.place_id = parseInt($stateParams.place_id);
  console.log('Place ID : ' + place.place_id);
  place.post = RemoteAPIService.getPost(place.place_id);
  place.post = {
    userPost: {
      name: null,
      notes: [{
